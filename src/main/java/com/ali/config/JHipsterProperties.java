...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "reporttest@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "reporttest API";

        private String description = "reporttest API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "reporttest";
